...
For a more comprehensive guide to writing your own rules check out `Writing a new rule <rules.rst>`_.
...
For a list of CLI options, runtime options and configuration attributes see the `Configuration <configuration.rst>`_ guide.
